                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-700">
                      After completing your registration form, please use one of the following payment methods to secure
                      your spot:
                    </p>
              ...
              <TabsContent value="registration" className="mt-6 space-y-4">
                <div className="bg-white p-4 rounded-lg border">
                  ...
                  <p className="text-gray-600 mt-2">
                    You can register online through our website by completing the registration form. Payment can be made
